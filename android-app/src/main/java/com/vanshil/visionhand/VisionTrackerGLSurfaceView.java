...
public class VisionTrackerGLSurfaceView extends BetterCameraGLSurfaceView implements BetterCameraGLSurfaceView.CameraTextureListener {
   ...
   // protected int procMode = OpenCVNativePart.DISP_MODE_TARGETS_PLUS;
...
//        OpenCVNativePart.TargetsInfo targetsInfo = new OpenCVNativePart.TargetsInfo();
...
//
//        OpenCVNativePart.processFrame(texIn, texOut, width, height, procMode, hRange.first, hRange.second,
  //              sRange.first, sRange.second, vRange.first, vRange.second, targetsInfo);
        //OpenCVNativePart.processFrame(texIn, texOut, width, height, 1, 0, 0, 0, 0, 0, 0, targetsInfo);
...
//            OpenCVNativePart.TargetsInfo.Target target = targetsInfo.targets[i];
//
